...
#ifndef MEDEASPECIALIZATIONCONTROLLER_H
#define MEDEASPECIALIZATIONCONTROLLER_H
...
class MedeaSpecializationController : public Controller
{
private:
    int _iteration;
...
public:
    ...
    MedeaSpecializationController(RobotWorldModel *wm);
    ~MedeaSpecializationController();
