...
#ifndef POPGENMODELSCONTROLLER_H
#define POPGENMODELSCONTROLLER_H
...
class PopGenModelsController : public Controller
{
private:
    int _iteration;
...
public:
    ...
    PopGenModelsController(RobotWorldModel *wm);
    ~PopGenModelsController();
