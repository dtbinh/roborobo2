...
PopGenModelsAgentObserver::PopGenModelsAgentObserver( RobotWorldModel *wm )
{
    _wm = (RobotWorldModel*)wm;
    
}

PopGenModelsAgentObserver::~PopGenModelsAgentObserver()
{
    // nothing to do.
}

void PopGenModelsAgentObserver::reset()
{
    // nothing to do.
}

void PopGenModelsAgentObserver::step()
{
